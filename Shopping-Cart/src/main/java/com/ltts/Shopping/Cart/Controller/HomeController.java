...
import com.ltts.Shopping.Cart.Entity.Basket;
import com.ltts.Shopping.Cart.Entity.Customer;
import com.ltts.Shopping.Cart.Entity.Items;
import com.ltts.Shopping.Cart.Entity.ShoppingCart;
...
public class HomeController {
    ...
    public void addcustomers(){
        ...
        shoppingCart.add_customer(new Customer("Shaloo","12457854",new Basket()));
        shoppingCart.add_customer(new Customer("kricha","87417854",new Basket()));
        shoppingCart.add_customer(new Customer("Abhishek","958417854",new Basket()));
        shoppingCart.add_customer(new Customer("sai","958417854",new Basket()));
        shoppingCart.add_customer(new Customer("Akash","958417854",new Basket()));
